...
import hello.batch.core.domain.accounts.Accounts;
...
public class TrMigrationConfig {
    ...
    @JobScope
    @Bean
    public Step trMigrationStep(ItemReader trOrdersReader, ItemProcessor trOderProcessor, ItemWriter trOrdersWriter) {
